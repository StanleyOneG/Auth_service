...
def test_user_logout(testing_user_login, patch_request):
    """Should logout user."""
    response: Response = testing_user_login()
...
def test_refresh_jwt_tokens(testing_user_login, delete_request):
