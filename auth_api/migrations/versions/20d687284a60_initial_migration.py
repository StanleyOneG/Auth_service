...
Revision ID: 20d687284a60
Revises: 
Create Date: 2023-04-22 00:12:31.178271
...
def upgrade():
    ...
    with op.batch_alter_table('user_login_history', schema='auth') as batch_op:
        batch_op.create_index('user_login_history_login_at_idx', ['login_at'], unique=False)
...
def downgrade():
    ...
    with op.batch_alter_table('user_login_history', schema='auth') as batch_op:
        batch_op.drop_index('user_login_history_login_at_idx')
